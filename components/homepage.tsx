      ...
      <section className="relative z-10 flex min-h-[calc(100vh-72px)] flex-col items-center justify-center px-4">
        ...
        >
          <input
            ...
            className="w-full border border-neutral-300 bg-white px-6 py-4 text-base text-black shadow-sm outline-none transition focus:border-neutral-400 focus:ring-2 focus:ring-neutral-200"
          />
